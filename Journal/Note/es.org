...
**** intro
the _Small Device C Compiler_ (/sdcc/) is a free-software, partially
retargetable c compiler for microcontrollers. it is distributed
...
[[~/Document/EmbeddedSystem/芯片手册/at89s52.pdf][at89s52]]
...
**** TOBECONTINED usbasp测试
- State "TOBECONTINED" from ""           [2015-12-09 三 13:26] \\
  usbasp Ubuntu 下测试
2015/12/09
...
atmega8a
[[/home/ben/Wally/Journal/Figures/scrot/2472pvk.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/247225q.png]]

***** 虚拟机中测试

装驱动：51开发板的资料中有，可以用。

#+INCLUDE: ~/Document/EmbeddedSystem/51/开发板/步骤2安装单片机开发相关软件/烧录软件/其它种类单片机/AT系列烧录工具_USBASP资料

烧录软件: /progisp/

[[/home/ben/Wally/Journal/Figures/scrot/2472CYG.png]]
...
*** TODO Atmega16                                                :atmega16:
- State "TODO"       from ""           [2015-12-15 二 19:54] \\
  测试使用 avrdude 烧录程序， OK
...
***** [[http://askubuntu.com/questions/77399/are-there-any-alternative-programs-to-proteus-available][wine]]                                                         :wine:
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\linewidth]{/home/ben/Tiger/Figures/1503290121.jpg}
\end{figure}
...
\begin{figure}[ht]
\centering
\includegraphics[width=0.7\linewidth]{/home/ben/Tiger/Figures/1503290149.jpg}
\end{figure}
...
[[/home/ben/Tiger/Figures/scrot/18640jwg.png]]
...
1. Foundation
   ...
   [[/home/ben/Wally/Journal/Figures/scrot/20587mNw.png]]

2. Board Implementation

   [[/home/ben/Wally/Journal/Figures/scrot/20587zX2.png]]

3. Embedded Intelligence Implementation

   [[/home/ben/Wally/Journal/Figures/scrot/20587yrL.png]]

*** shortcuts

右下角标签页，动态显示

[[/home/ben/Wally/Journal/Figures/scrot/20587ZKe.png]]

*** PCB
**** 设计流程

[[/home/ben/Wally/Journal/Figures/scrot/20587mUk.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/20587Nz2.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/20587Awk.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/20587MOA.png]]
...
1. /抗干扰/
   ...
   1) 电源线的设计
      ...
      [[/home/ben/Wally/Journal/Figures/scrot/20587aLl.png]]

   2) 地线

      [[/home/ben/Wally/Journal/Figures/scrot/205870fx.png]]

   3) 元器件配置

      [[/home/ben/Wally/Journal/Figures/scrot/20587A-M.png]]

   4) 去耦电容

      [[/home/ben/Wally/Journal/Figures/scrot/20587ncf.png]]

   5) 降低噪声

      [[/home/ben/Wally/Journal/Figures/scrot/20587O7x.png]]

   6) 其它设计原则

      [[/home/ben/Wally/Journal/Figures/scrot/20587aZN.png]]
...
**** 链接器脚本
#+BEGIN_SRC latex
\includepdf[pages={1-}, nup=2x4, frame=true, delta={12pt 12pt}]{/home/ben/Document/ARM/ARM/2/第2季-裸奔吧-ARM/上学期/专题1-工欲善其事-必先利其器/第4课-链接器脚本/链接器脚本.pdf}
#+END_SRC
...
#+BEGIN_SRC latex
\includepdf[pages={1-}, nup=2x4, frame=true, delta={12pt 12pt}]{/home/ben/Tiger/Ref/Makefile工程管理.pdf}
#+END_SRC
...
[[/home/ben/Wally/Journal/Figures/scrot/8571bvf.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/8571ofl.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/8571bpr.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/8571ozx.png]]

** booterloader                                                 :bootloader:
*** what's  next

[[/home/ben/Wally/Journal/Figures/scrot/5970lht.png]]
...
**** uboot快速体验
[[/home/ben/Wally/Journal/Figures/scrot/5970yrz.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/5970lbf.png]]

[[/home/ben/Wally/Journal/Figures/scrot/5970yll.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/5970_vr.png]]
...
***** 地址布局
[[/home/ben/Wally/Journal/Figures/scrot/5970m6x.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/5970-db.png]]
...
***** 地址映射
[[/home/ben/Wally/Journal/Figures/scrot/5970loh.png]]
...
***** 启动过程
[[/home/ben/Wally/Journal/Figures/scrot/5970yyn.png]]
...
**** 路径和其它选项(Paths and Misc Options)
...
2. Endianness: Little endian
   ...
   [[/home/ben/Wally/Journal/Figures/scrot/49045DS.png]]
...
**** 操作系统选项(Operating system)

+ Target OS: linux

+ Linux kernel version: 2.6.32 (简单起见)
...
#+begin_latex
  \begin{minted}[frame=leftline, mathescape]{text}
  cross-sandbox $ ls  ~/.x-tools/
  arm-wally-linux-gnueabi
  cross-sandbox $ ls ~/.x-tools/arm-wally-linux-gnueabi/
  arm-wally-linux-gnueabi  bin  build.log.bz2  include  lib  libexec  share
  cross-sandbox $ ls ~/.x-tools/arm-wally-linux-gnueabi/bin/
  arm-wally-linux-gnueabi-addr2line     arm-wally-linux-gnueabi-elfedit     arm-wally-linux-gnueabi-gprof     arm-wally-linux-gnueabi-ranlib
  arm-wally-linux-gnueabi-ar            arm-wally-linux-gnueabi-g++         arm-wally-linux-gnueabi-ld        arm-wally-linux-gnueabi-readelf
  arm-wally-linux-gnueabi-as            arm-wally-linux-gnueabi-gcc         arm-wally-linux-gnueabi-ld.bfd    arm-wally-linux-gnueabi-size
  arm-wally-linux-gnueabi-c++           arm-wally-linux-gnueabi-gcc-4.9.4   arm-wally-linux-gnueabi-ldd       arm-wally-linux-gnueabi-strings
  arm-wally-linux-gnueabi-cc            arm-wally-linux-gnueabi-gcc-ar      arm-wally-linux-gnueabi-nm        arm-wally-linux-gnueabi-strip
  arm-wally-linux-gnueabi-c++filt       arm-wally-linux-gnueabi-gcc-nm      arm-wally-linux-gnueabi-objcopy
  arm-wally-linux-gnueabi-cpp           arm-wally-linux-gnueabi-gcc-ranlib  arm-wally-linux-gnueabi-objdump
  arm-wally-linux-gnueabi-ct-ng.config  arm-wally-linux-gnueabi-gcov        arm-wally-linux-gnueabi-populate
  \end{minted}
#+end_latex
...
+ [[~/Document/EmbeddedSystem/软件手册/OpenocdManual.pdf][Openocd Manual]]
...
[[/home/ben/Wally/Journal/Figures/scrot/5070dLV.png]]
...
的单板机电脑。
[[/home/ben/Wally/Journal/Figures/scrot/5070Ejz.png]]
1. 单板机电脑
2. 体积小： 85x54(B+)
3. 配置
   1) CPU
...
5. [[http://blog.csdn.net/hcx25909/article/category/1759051][blog 古月
   居： 树莓派Linux驱动学习系列（不多3篇，仅入门）]]
...
[[/home/ben/Wally/Journal/Figures/scrot/24567mMA.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/24567zWG.png]]

[[/home/ben/Wally/Journal/Figures/scrot/24567AhM.png]]

**** 设置 scv 模式

***** how

[[/home/ben/Wally/Journal/Figures/scrot/24567NrS.png]]

Linux/bootloader 工作在 Supervisor(/svc/) 模式

通过程序状态寄存器(/CPSR/)设置 (M[4:0])

[[/home/ben/Wally/Journal/Figures/scrot/24567a1Y.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/24567n_e.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/24567Oex.png]]
...
2. 中断屏蔽寄存器: /INTMASK/:INTERRUPT MASK (INTMSK) REGISTER(2440)
   ...
   [[/home/ben/Wally/Journal/Figures/scrot/24567AoA.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/24567NyG.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/24567a8M.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/245670QZ.png]]
...
[[/home/ben/Wally/Journal/Figures/scrot/24567Bbf.png]]
...
*** [[#+INCLUDE: ~/Wally/Journal/Project/ARM/led][led]]
...
1. 常见驱动电路
   ...
   [[/home/ben/Wally/Journal/Figures/scrot/24567auk.png]]

2. GPIO

   [[/home/ben/Wally/Journal/Figures/scrot/24567n4q.png]]
...
**** make
#+INCLUDE: ~/Wally/Journal/Project/ARM/led/Makefile
...
#+begin_latex
  ...
  > nand erase 0
  s3c2440_read_block_data: reading data: 0xa0b1820, 0xbfb51136, 6
  s3c2440_read_block_data: reading data: 0xa0b1820, 0xbfb51136, 6
  s3c2440_read_block_data: reading data: 0xa0b1820, 0xbfb51136, 6
  s3c2440_read_block_data: reading data: 0xa0b1820, 0xbfb51136, 6
  s3c2440_read_block_data: reading data: 0xa0b1820, 0xbfb51136, 6
  ...
  target must be halted to use S3C24XX NAND flash controller
  target must be halted to use S3C24XX NAND flash controller
  unknown NAND flash device found, manufacturer id: 0x30 device id: 0x30

  > halt
  target state: halted
  target halted in ARM state due to debug-request, current mode: Supervisor
  cpsr: 0x300000d3 pc: 0x009f38d8
  MMU: disabled, D-Cache: disabled, I-Cache: disabled

  > nand write 0 /home/ben/Wally/Journal/Project/ARM/led/led.bin 0
  wrote file /home/ben/Wally/Journal/Project/ARM/led/led.bin to NAND
  flash 0 up to offset 0x00000800 in 2.092015s (0.099 KiB/s)

  > resume
  \end{minted}
#+end_latex

** TOBECONTINED ARM嵌入式系统开发---软件设计与优化             :arm:project:
*** DONE ARM基础
**** RISC设计思想
...
+ 修订版本号
+ 稳定版本号(可选)
  [[/home/ben/Tiger/journal/figures/48846MU.png]]
