...
**** [[http://wiki.ros.org/rosbag/Commandline][CommandLine]]         :cmd:
***** record                                                     :record:
...
Determine whether a bag is playable in the current system, or if it
can be migrated.

***** fix

Repair the messages in a bag file so that it can be played in the
current system.
...
在 record 时，关闭发布话题的节点，会使 record 失败，生成的文件带有后缀
/.active/, 需要使用 reindex
...
*** [[http://wiki.ros.org/roslaunch][roslaunch]]                :roslaunch:
...
5. *machine*: Launch node on designated machine

6. *respawn*: true/false
...
9. *clear_parameters* : true/false

   Delete all parameters in the node's private namespace before launch

10. *output*: log | screen

    where the stdout/stderr goes

11. *cwd*: ROS_HOME | node

12. *launch-prefix*: prefix arguments
...
** [[http://wiki.ros.org/rqt][rqt]]                                 :qt:rqt:
...
** Hector                                                           :hector:
*** [[http://wiki.ros.org/hector_slam][hectorslam]]                  :slam:
**** [[http://wiki.ros.org/hector_slam/Tutorials][tutorials]]   :tutorial:
...
**** [[http://wiki.ros.org/hector_mapping][hector_mapping]]
...
** Lidar                                                       :lidar:laser:
*** [[http://wiki.ros.org/hokuyo_node][hokuyo_node]]         :hokuyo:lidar:
**** API                                                             :api:
***** parameter
...
#+DOWNLOADED: /tmp/screenshot.png @ 2015-06-17 21:54:52
 [[~/Tiger/Figures/ROS/screenshot_2015-06-17_21:54:52.png]]
...
**** [[http://wiki.ros.org/laser_filters][laser_filters]]
...
**** [[http://wiki.ros.org/laser_assembler?distro=jade][laser_assembler]]
**** TODO error
...
2. Published Topics
   ...
   + *~entropy* (std_msgs/Float64)
     ...
     Estimate of the entropy of the distribution over the robot's pose
     (a higher value indicates greater uncertainty). New in 1.1.0.
