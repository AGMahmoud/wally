...
** 2016/01/19 Doubt Emacs

第一次怀疑像我这么折腾 Emacs 是否有意义，也是第一次在熟练使用 Emacs 后
怀疑花费这么多的精力是否值得。

每一次尝试使用 Emacs 打造 IDE 都会把自己搞得身心俱疲，转战 VIM 更是力
不从心。

我不想再这么折腾了，我想踏踏实实地做一些真正的项目。

在 [[https://github.com/yangyangwithgnu/use_vim_as_ide#5.6][使用 VIM 打造 C++ IDE]] 一文中，作者提到判断好的 IDE 的标准：“只要你
能得心应手地完成软件开发任务，又察觉不到工具的存在，那这就是最适合你的
IDE。” 从这个角度讲，Emacs 对我来说不是一个好的工具。但这不是 Emacs
的问题，而是我的问题。我太执着于器了。

关于君子不器，我已经思考过不止一遍了，可是每次我都做不好。

我希望自己接下来的一年里，不再折腾 Emacs IDE 和 VIM 了。不再纠结于工具
本身，而是要好好地做事，即使蹩脚一点。
...
上午被 Ubuntu dpkg 的包依赖关系问题困扰了一上午。

下午纠结于 Emacs IDE。

晚上状态不佳，打了一晚上 Dota。

回寝接着熬夜打 Dota，因为竹心情极差，睡前喝了一两白酒，次日睡到十点半。
** dpkg error                                                        :error:
