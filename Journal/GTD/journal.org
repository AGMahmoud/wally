...
[09:04]
昨晚在水木上发现了 spacemacs ，按网上的说法是一个极好的 Emacs 配置，在
GitHub 的星星数 6000+，也证实了这一点。
为此被搞得心神不宁，我又开始瞎折腾了（曾许诺过不再这样了）。
一个晚上，加之现在的早晨

[14:56]
午餐吃得晚，刚刚午休醒。
上午一直在琢磨 Spacemacs，花费了巨大精力。希望有所价值。

[17:09]
一直整理到现在，才稍微整明白了 Spacemacs，希望这一切都是值得的。
