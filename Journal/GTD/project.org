...
* Project                                                           :proj:
** [[~/Wally/Project/README.md][README]]

#+BEGIN_SRC markdown :tangle ~/Wally/Project/README.md
  # README.md
...
** [[~/Wally/Project/ChangeLog.txt][ChangeLog]]

#+BEGIN_SRC text :tangle ~/Wally/Project/ChangeLog.txt
...
** 2D SLAM in Python
*** [[~/Wally/Project/SLAM/SLAM2dPython/README.md][README]]

*** [[~/Wally/Project/SLAM/SLAM2dPython/ChangeLog.txt][ChangeLog]]
...
** toolbox                                                      :bash:style:
*** [[~/Wally/Project/toolbox/README.md][README]]

#+BEGIN_SRC markdown :tangle ~/Wally/Project/toolbox/README.md
  # toolbox

  toolbox that contains useful bash scripts
#+END_SRC
*** [[~/Wally/Project/toolbox/ChangeLog.txt][ChangeLog]]

#+BEGIN_SRC text :~/Wally/Project/toolbox/ChangeLog.txt
  # toolbox changelog

  # 2015/12/16

  ,* initialize project and arrange exsiting bash scripts

  # 2015/12/18

  ,* standardize file name
  ,* convert pptx/ppt to pdf in batch
...
#+NAME: standardize_filename
#+BEGIN_SRC sh :tangle ~/Wally/Project/toolbox/src/stdfn.sh
  #!/usr/bin/env bash
...
#+NAME: pptx2pdf
#+BEGIN_SRC sh :tangle ~/Wally/Project/toolbox/src/pptx2pdf.sh
  #!/usr/bin/env bash
...
#+BEGIN_SRC sh :tangle ~/Wally/Project/toolbox/src/mergepdfs.sh
  #!/usr/bin/env bash
