...
** ChangeLog
+ 2015/12/15
  - add a changelog item to follow Journal
  - move Project to parent folder, simplify Journal
  - move catkin_ws to Project
  - merge LEDGER file
...
** [[~/Wally/Journal/Project/SLAM/SLAM2dPython][Python SLAM]]
...
#+INCLUDE: ~/Wally/Journal/Project/LaTeX/BUAAthesis
...
** [[~/Document/Refence][Reference]]

#+INCLUDE: ~/Document/Reference/REAMDE.org
#+INCLUDE: ~/Document/Reference/ChangeLog.org

** memo                                                               :memo:
*** ChangeLog

+ 2015/12/14
  - 构想使用 org + beamer 建立所有需要快速参考的资料
  - 规化了基本大纲
...
使用 rosbag /--pause/ 选项， 单步发送消息，笨了些，但是实用。

GDB 调试其它接收 topic 的节点。
...
*** 2015/12/16  关于
*** TODO project LANGUAGE PROJECT

#+INCLUDE: ~/Wally/Journal/Project/CMake/tagerill_pro/scripts/tagerill_update_project.sh :scr sh

*** list path structure                                        :python:elisp:
- State "TOBECONTINED" from ""           [2015-12-08 二 14:42]

#+include: ~/Wally/Journal/Project/Python/scripts/listdir.py :src python

#+BEGIN_SRC emacs-lisp
  (defun listdir(path)
    (call-process-shell-command python ~/Wally/Journal/Project/Python/scripts/listdir.py path)
    )
...
不行， python 不是 shell 命令，因而不是有效的变量

TODO： /直接使用 elisp 递归生成可视目录/

*** Never

1. 永远不要在状态不佳的时候强迫自己熬夜
2. 永远不要相信自己熬夜能做很多事情
3. 永远不要把自己的时间过于分散化
...
*** TODO 在routines中同步Emacs配置文件及Yasnippet

#+BEGIN_SRC sh
# track emacs settings
emacs_settings_ws="~/.emacs.d"
...
*** TODO stardict 单词导出 换行符 为界限，作成卡片
*** TODO 多个参考文献引用需要如何标记

[[/home/ben/Wally/Journal/Figures/scrot/2472PbY.png]]

*** TODO FoxitReader 标记类型

1. Note 表示想法
2. Underline 表示可以引用的内容
3. 高亮 表示需要查阅的文献
4. 删除线 表示不赞同的地方
*** TODO 编程风格。、doxygen注释、vim、Emacs快捷键 打印
*** TODO # 在 elisp 中 对应 map？

(add-hook 'eshell-mode-hook
            #'(lambda ()
                (define-key eshell-mode-map (kbd "M-l")  'helm-eshell-history)))

*** TODO 关掉 bibtex parse

Debugger entered--Lisp error: (wrong-type-argument number-or-marker-p nil)
  #[0 "eb\210\f\203~\00\306
\307\310\311R \312\313\306#\203x\00\300\203&\00\314 \203&\00\315\316\317\"\210\320\225\203G\00\321\320\224T\320\225S\"\322\303\242\"\204C\00\303C\303\242B\240\210\210\202\00\323\321!\224T!\225\"\"\306#\203\00\313\324#!\206a\00\211\262\322\302\242\"\204t\00\302\306B\302\242B\240\210\210\202\00)\266\202\233\00\306\313C$\325\326\327\330\331\332\300\301\302\303\n%\333\"\334\335%!\210)\266\303\242\211\203\272\00\211@\322@\302\242\"\204\263\00\302\302\242B\240\210A\266\202\202\235\00\210\301\203\303\00\336\337!\210\302\242\211%\207" [t nil (nil) (nil) bibtex-parse-keys-fast bibtex-entry-head t "\\|" ",[ 	\n]*crossref[ 	\n]*=[ 	\n]*" "\\(\"[^\"]*\"\\|{[^}]*}\\)[ 	\n]*[,})]" re-search-forward nil input-pending-p throw userkey aborted 3 buffer-substring-no-properties assoc assoc-string match-string-no-properties bibtex-map-entries make-byte-code 771 "\300\203\00\305 \203\00\306\307\310\"\210\301\203\00\311 \210\312\302\242\"\204&\00\302\313B\302\242B\240\210\304\314\315\"\240\205J\00\316\304\242\313\"\211\262\205J\00\312\303\242\"?\205J\00\303C\303\242B\240\207" vconcat vector [input-pending-p throw userkey aborted bibtex-progress-message assoc t bibtex-search-forward-field "crossref" bibtex-text-in-field-bounds] 7 "\n\n(fn KEY BEG END)" bibtex-progress-message done case-fold-search bibtex-type-in-head bibtex-entry-alist bibtex-key-in-head bibtex-sort-ignore-string-entries bibtex-reference-keys] 13 "\n\n(fn)"]()
  funcall(#[0 "eb\210\f\203~\00\306
\307\310\311R \312\313\306#\203x\00\300\203&\00\314 \203&\00\315\316\317\"\210\320\225\203G\00\321\320\224T\320\225S\"\322\303\242\"\204C\00\303C\303\242B\240\210\210\202\00\323\321!\224T!\225\"\"\306#\203\00\313\324#!\206a\00\211\262\322\302\242\"\204t\00\302\306B\302\242B\240\210\210\202\00)\266\202\233\00\306\313C$\325\326\327\330\331\332\300\301\302\303\n%\333\"\334\335%!\210)\266\303\242\211\203\272\00\211@\322@\302\242\"\204\263\00\302\302\242B\240\210A\266\202\202\235\00\210\301\203\303\00\336\337!\210\302\242\211%\207" [t nil (nil) (nil) bibtex-parse-keys-fast bibtex-entry-head t "\\|" ",[ 	\n]*crossref[ 	\n]*=[ 	\n]*" "\\(\"[^\"]*\"\\|{[^}]*}\\)[ 	\n]*[,})]" re-search-forward nil input-pending-p throw userkey aborted 3 buffer-substring-no-properties assoc assoc-string match-string-no-properties bibtex-map-entries make-byte-code 771 "\300\203\00\305 \203\00\306\307\310\"\210\301\203\00\311 \210\312\302\242\"\204&\00\302\313B\302\242B\240\210\304\314\315\"\240\205J\00\316\304\242\313\"\211\262\205J\00\312\303\242\"?\205J\00\303C\303\242B\240\207" vconcat vector [input-pending-p throw userkey aborted bibtex-progress-message assoc t bibtex-search-forward-field "crossref" bibtex-text-in-field-bounds] 7 "\n\n(fn KEY BEG END)" bibtex-progress-message done case-fold-search bibtex-type-in-head bibtex-entry-alist bibtex-key-in-head bibtex-sort-ignore-string-entries bibtex-reference-keys] 13 "\n\n(fn)"])
  bibtex-parse-keys(t)
  bibtex-parse-buffers-stealthily()
  apply(bibtex-parse-buffers-stealthily nil)
  byte-code("r\301\302H\303H\"\210)\301\207" [timer apply 5 6] 4)
  timer-event-handler([t 0 60 0 t bibtex-parse-buffers-stealthily nil idle 0])
  accept-process-output()
  byte-code("\306p\307p\307\306\310\311\312 \"\"\"\306\211
;\205\00\313
!!\"\205^\00\314\315!\205+\00
?\205^\00#?\205^\00!\204E\00
;\203E\00\316
!\204R\00!\205^\00\313
\306\317#\205^\00$\320X\206^\00\321 $W)\203h\00\212\322p!)\204p\00p\fB\n\306%\211&\203W&@%'\203\242\00\323 \204\234\00\212\324(!q\210\325(!b\210\326 )\203\242\00\327'\330\"\210r%q\210
;\205\257\00\313
!!\"\205\361\00\314\315!\205\276\00
?\205\361\00#?\205\361\00!\204\330\00
;\203\330\00\316
!\204\345\00!\205\361\00\313
\306\317#\205\361\00$\320X\206\361\00\321 $W)\203M
;\205\375\00\313
!!\"\205?\314\315!\205\f
?\205?#?\205?!\204&
;\203&\316
!\2043!\205?\313
\306\317#\205?$\320X\206?\321 $W)\203M\322p!\204Mp\fB)&A\211&\204z\00*\331\332!\203\201\333 \203\201\334 \210)\203~*\203y	q\210\335 \210\202~\336\337\340\217\210\334 \210-\306\207" [inhibit-quit cb buffers safe errbuf buffer-file-name nil delq mapcar #[(b) "\301!\205\00\207" [b buffer-file-name] 2] buffer-list file-remote-p boundp semantic-debug-enabled file-exists-p t 0 buffer-size semantic-idle-work-for-one-buffer input-pending-p marker-buffer marker-position accept-process-output throw parsing-mode-buffers featurep semantic/db semanticdb-minor-mode-p semanticdb-save-all-db-idle semantic-idle-scheduler-work-parse-neighboring-files err (byte-code "q\210\301 \207" [cb semantic-idle-scheduler-work-parse-neighboring-files] 1) ((error (byte-code "\301\302\303\304p\305!#\"\207" [err message "Idle Work Parse Neighboring Files: %S" format "%S - %s" error-message-string] 7))) remote-file\? semantic-idle-scheduler-mode semantic-lex-debug semantic-idle-scheduler-max-buffer-size b --dolist-tail-- semantic-current-input-throw-symbol semantic--on-input-start-marker semantic-idle-work-parse-neighboring-files-flag debug-on-error] 8)
  semantic-idle-work-core-handler()
  semantic-idle-scheduler-work-function()
  apply(semantic-idle-scheduler-work-function nil)
  byte-code("r\301\302H\303H\"\210)\301\207" [timer apply 5 6] 4)
  timer-event-handler([t 0 60 0 t semantic-idle-scheduler-work-function nil idle 0])
*** TODO voronoi（哦若闹哎）泰森多边形法
*** TODO doxygen asm
*** TODO html filters for wkhtmltopdf
*** TODO buffer local variable how to define
*** TODO 非标题标签，有时会需要
*** TODO markdown 入门
*** TODO 快速 wrap region C-c w 8///-
...
* Project                                                           :project:
** ChangeLog
#+include: ~/Wally/Journal/Project/ChangeLog.txt
#+include: ~/Wally/Journal/Project/README.org

** toolbox
#+include: ~/Wally/Journal/Project/toolbox/README.md
...
*** TODO boost bind
*** TODO boost thread
*** TODO 写论文摘要，或者说写论文目标以及论文结构
*** lower layer PID for motor control
...
嵌入式Linux成为嵌入式开发的主流平台。
**** Building Embedded Linux(SlideShare)
/home/ben/Document/EmbeddedLinux/BuidlEmbeddedLinuxForARM.pdf

*Using Linux in an embedded project is easier, and more fun,  than
ever*
***** Tips for Linux
...
+ Only use the root user for operations that require

***** Hardware for Linux Systems

****** Processor and Arch
1. The Linux kernel and most other architecture-dependent component
   support a wide range of 32 and 64 bits architecture
   + x86 and x86-64
   + ARM
   + PowerPC(mainly realtime, industrial application)

2. RAM
   - A very basic Linux system can work *within 8 MB of RAM*
   - A more realistic system will ususally require *at least 32MB of
     RAM*.  Depends on the type and size of application.

3. Storage
   - A very basic Linux system can work *within 4MB of storage*, but
     ususally more is needed
   - Flash storage is supported, *both NAND and NOR flash*, with
     specific filesystems.
   - Block storage including SD/MMC casrd and eMMC.

****** Communication
1. The Linux kernel has support for many common communication busses
   + USB
   + SPI
   + CAN
   + 1-wire

2. And also extensive networking support
   + Ethernet, Wi, Bluetooth, CAN, etc
   + IPV4, IPV6, TCP, UDP, etc.
   + Firewalling, advanced routing.

****** Types of HW platforms
1. *Evaluation platforms* from the SoC vendor. Ususally expensive, but
   many peripherals are built-in. Generally unsuitable for real
   product.(整板，包括外设)

2. *Component on Module*, a small board with only CPU/RAM/ash and a
   few other core components,  with connectors to access all other
   peripherals. Can be used to build end products for small to medium
   quantities.(核心板，不包括外设)

3. *Custom platform* Schematics for evaluation boards or development
   platforms are more and more commonly freely available,  making it
   easier to develop custom platforms.(*Open Hardware*)

****** Tips for HW
+ Make sure the hardware you plan to use is already supported by the
  Linux kernel, and has an *open-source bootloader*
+ ...
***** Software Components
****** Sofeware components
...
+ Linaro(ready-made):http://www.linaro.org/
+ Buildroot(tool to build): http://www.buildroot.net/
+ CrosstoolNG(tool to build): http://crosstool-ng.org/
...
2. Cross-ToolChain compents
   #+DOWNLOADED: /tmp/screenshot.png @ 2015-06-30 15:15:08
...
3. *Binutils*
   ...
   + *as*, the assembler, that generates binary code from assembler
     source code
   + *ld*, the linker
   + *ar*, randlib,  to generate .a archives, used for libraries
   + objdump, readelf, size, nm, strings, to inspect binaries. Very
...
6. C Library
   ...
   + Severl C libraries are available
     - glibc, uClibc, eglibc, dietlibc, newlbi, etc
   + The choice of the C library must be made at the time of the
...
问题1： Don't set LD_LIBRARY_PATH. It screws up the build
修改 ~/.bashrc并重新sourcr

问题2：Could not retrieve 'cloog-ppl-0.15.9
setting CT_CLOOG_V_0_15_11=y instead worked for downloading
http://sourceware.org/ml/crossgcc/2014-04/msg00019.html
...
**** Embeded Linux Trainning

***** introduction to embedded linux
****** what is embedded linux?

Embedded Linux is the usage of the *Linux kernel* and various *open
source* components in embedded systems.
...
+ Taking part into the community
  Most the time the open-source components are not the core value of
  the product: it's the interest of everybody to contribute back
...
1. Processors
   ...
   + PowerPC (mainly real-time, industrial application)
   + MISP (mainly networking application)
   + SuperH (top box)
   + Blackfin (DSP architecture)
   + Microblaze (FPGA)
   + Coldfire, AVR32 ...

2. *both MMU and no-MMU* architectures are supported

3. Linux is not designed for small microcontroller

4. Besides the toolchain, the bootloader and the kernel, all other
   components are generally *architecture-independent*

******* RAM and storage
1. *RAM* : a very basic Linux system can work within *8 MB* of RAM,
   but    a more realistic system will ususally require at least 32 MB
   of RAM. Depends on the type and size of applications

2. *Storage* : a very basic Linux system can work within *4 MB* of
   storage,  but ususally more is needed
   1) *Flash storage* is supported, both NANA and NOR flash, with
      specific filesystem
   2) *Block storage* including SD/MMC cards and eMMC is supported

******* Communication
1. The Linux kernel has support for many common communication buses
   + I2C
   + SPI
   + CAN
   + 1-wire
...
******* Global architecture
[[~/Wally/Journal/Figures/scrot/3513G8e.png]]
...
******* Embedded Linux work
1. *Board Support Package(BSP)* support
   A BSP contains a bootloader and kernel with the suitabel device
   drivers for the targeted hardware

2. System integration
   Integrate all the components, bootloader, kernel, third-party
   libraries and applications and in-house application into working
   system

3. Development of applications
   Normal Linux application, but using specifically chosen libraries

***** Embedded Linux development environment

****** Embedded Linux solutions
1. use solutions provided and supported by vendors
2. use community solutions: knowing the concepts, switching to vender
   solutions will be easy

****** OS for Linux develop
OS: Linux
[[~/Wally/Journal/Figures/scrot/3513TGl.png]]

Linux distribution: ubuntu

****** Host vs Target
[[~/Wally/Journal/Figures/scrot/3513gQr.png]]
...
+ *ttyS* for real serial ports

Using the command line is mandatory for many operations needed for
embedded Linux development. It is a very powerful way of interacting
with the system, with which you can save a lot of time

***** Cross-compiling toolchains

****** definition
*Cross-compiling toolchains* run on your workstation but generate code
for your target

[[~/Wally/Journal/Figures/scrot/3513tax.png]]

****** components
[[~/Wally/Journal/Figures/scrot/3513fkA.png]]
...
+ *as*, the assembler, that generates binary code from assembler
  source code
+ *ld*, the linker
+ *ar, ranib*, to generate *.a* archives, used for libraries
+ *objdump, readelf, size, nm, strings*, to inspect binaries. very
  useful analysis tools
...
******* Kernel headers
[[~/Wally/Journal/Figures/scrot/3513suG.png]]
...
corresponding to the ones in *include/* in the kernel sources
...
******* GCC
[[~/Wally/Journal/Figures/scrot/351354M.png]]


+ GNU Compiler Collection
+ can compile multiple languages in multiple architectures
+ http://gcc.gnu.org

****** C library
The C library is an essential component of a Linux system
1) interface between the application and the kernel
2) provides the well-known standard C API to ease application
   development

Serveral C libraries are available
+ glibc
+ uClibc
+ eglibc
+ dietlibc
...
*The choice of the C library must be made at the time of the
cross-compiling tool chain generation*,  as the GCC compiler is
compiled against a specific C library
...
+ Quite big for small embedded systems (approx 2.5MB)
...
+ Works only with Linux/uClinux
+ focus on size rather than performance (600Kb)
+ revived by the uClibc-ng project: http://uclibc-ng.org/

******* eglibc
+ Embedded glibc

****** Toolchain Options
****** Obtainning a Toolchain
*** ABORT org快捷键显示当前heading其它折叠
- State "ABORT"      from "TODO"       [2015-11-27 五 17:26] \\
  不值得花费时间去折腾
 <2015-11-26 四>
 [[file:~/Wally/Journal/journal.org::*julie_gazebo][julie_gazebo]]
*** TODO org 截图 前缀 挂起Emacs
 <2015-12-02 三>
 [[file:~/Wally/Journal/journal.org::*minted%20%E6%89%8B%E5%86%8C][minted 手册]]
*** DONE yasnippet doxygen 注释 参照 ros
- State "DONE"       from "TODO"       [2015-12-05 六 23:39]
 <2015-12-05 六>
 [[file:~/Wally/Journal/journal.org::*%E5%AE%9E%E7%8E%B0][实现]]
*** TODO python标准注释风格
 <2015-12-06 日>
 [[file:~/Wally/Journal/journal.org::*%E6%97%A5%E4%BA%8B%E6%97%A5%E6%AF%95][日事日毕]]
** 循序渐进
*** README
...
- state "tobecontined" from "todo"       [2015-11-23 一 14:38]
- state "todo"       from ""           [2015-11-23 一 14:35] \\
  算法的圣经，我想做算法
...
- ROS的参考资料仅保存链接
  ...
  - Evernote 使用剪藏时分类并添加标签，不要再重新整理费时费力
  - 网络有用的参考资料先使用 Evernote 保存下来，在 Org 中链接到
    Evernote Link
*** Linux
...
+ 2048应该一节一节的来,每出现一个1024就停下来攒运气,  消消乐也是。 永
  远不要在不必要时玩手机游戏超过半个小时。
+ 遇到瓶颈时，先纠结一会，但不要太久，绕行，没准会柳暗花明
+ 可以晚归, 可以晚睡, 但不要把该在实验室完成的工作带回寝室,做到泾渭分
  明. 否决，不能晚归，不能熬夜，可以在宿舍学习
** 始于足下
*** ChangeLog
+ 增加changeLog
...
*** TODO 跑步
SCHEDULED: <2015-12-17 四 19:00 +1d>
...
SCHEDULED: <2015-12-17 四 22:00 +1d>
...
SCHEDULED: <2015-12-17 四 10:00 +1d>
- State "DONE"       from "TODO"       [2015-12-16 三 22:04]
...
SCHEDULED: <2015-12-17 四 14:00 +1d>
- State "DONE"       from "TODO"       [2015-12-16 三 22:04] \\
...
*** TODO [#B] Friends
SCHEDULED: <2015-12-17 四 18:30 +1d>
- State "DONE"       from "TODO"       [2015-12-16 三 22:05] \\
  S10E13
...
SCHEDULED: <2015-12-17 四 09:15 +1d>
- State "DONE"       from "TODO"       [2015-12-16 三 22:03]
- State "DONE"       from "TODO"       [2015-12-15 二 17:06]
...
:LAST_REPEAT: [2015-12-16 三 22:03]
:END:
*** TODO [#A] 长跑  可以不坚持晨跑，但长跑的训练不可少             :weekly:
SCHEDULED: <2015-12-19 六 +1w>
...
*** TODO [#A] 吉它练习1h+                                          :weekly:
SCHEDULED: <2015-12-19 六 16:00 +1w>
- State "Failed"     from "TODO"       [2015-12-14 一 09:37]
- State "Failed"     from "TODO"       [2015-12-05 六 23:37]
- State "Failed"     from "TODO"       [2015-12-05 六 23:37]
- State "Failed"     from "TODO"       [2015-11-22 日 13:49]
...
*** TODO [#B] 电影                                                 :weekly:
SCHEDULED: <2015-12-19 六 21:00 +1w>
...
*** TODO [#A] 周整理                                               :weekly:
SCHEDULED: <2015-12-20 日 14:00 +1w>
...
** Links
*** bookmarks
+ [[/media/ben/Reserch/Document/Emacs/Org/org_shortcut_card.pdf][ORG-mode shortcuts]]
+ [[/media/ben/Reserch/Document/EmbeddedSystem/ARM/ARM Architecture Reference Manual.pdf][ARM Architecture Reference M]]
+ [[/media/ben/Reserch/Document/EmbeddedSystem/ARM/ARM Architecture Reference Manual.pdf][ARM Manual]]
+ [[/media/ben/Reserch/Document/Programming/C++/Boost/BeyondSTL_AnIntroductionToBoost_Zh.pdf][Boost-BeyongSTL_AnIntroducti]]
+ [[/media/ben/Reserch/Document/Programming/C++/Boost/Boost库学习指南.pdf][Boost库学习指南.pdf]]
+ [[/media/ben/Reserch/Document/Programming/C++/C++Primer_4thEd_Zh_非扫描.pdf][C++Primer_4thEd_Zh_非扫描.pd]]
+ [[/home/ben/Document/Programming/CMake/CMakePractice.pdf][CMakePractice.pdf]]
+ [[/media/ben/Reserch/Document/Programming/C++/C/C程序设计语言_第2版_新版.pdf][C程序设计语言_第2版_新版.pdf]]
+ [[/media/ben/Reserch/Document/Programming/C++/doxygen/Doxygen使用教程.pdf][Doxygen使用教程.pdf]]
+ [[/media/ben/Reserch/Document/Linux/Emacs/GNUEmacsLisp编程入门_Zh.pdf][EmacsLisp编程入门]]
+ [[/media/ben/Reserch/Document/Linux/Emacs/yasnippet_manual.pdf][EmacsYasnippetRef]]
+ [[/media/ben/Reserch/Document/Emacs/Emacs快捷键.pdf][Emacs快捷键.pdf]]
+ [[~/Document/Emacs/Elisp/elispcookbook.pdf][Emacs Elisp Cookbook]]
+ [[/home/ben/Document/Linux/GccGdb/GDB教程详解_with_outline.pdf][GDB教程]]
+ [[/media/ben/Reserch/Document/Linux/Git/ProGit中文版.pdf][Git-ProGit]]
+ [[/media/ben/Reserch/Document/Linux/Git/Git权威指南.pdf][Git权威指南.pdf]]
+ [[/media/ben/Reserch/Document/Linux/gnuplot/gnuplot_4.6中文手册_修订2.pdf][GnuplotManual]]
+ [[/media/ben/Reserch/Document/Programming/TeX/tex_tutorial.pdf][LaTeX-IntroductionToLaTeX2e]]
+ [[/usr/local/texlive/2014/texmf-dist/doc/latex/listings/listings.pdf][LaTeX-listings package]]
+ [[/media/ben/Reserch/Document/Programming/TeX/一份不太简短的LaTeX2e介绍.pdf][LaTeX-一份不太简短的LaTeX2e介]]
+ [[/home/ben/Document/Programming/TeX/LaTeX2e完全学习手册_第二版_WithOutline.pdf][LaTeX2e完全学习手册_第二版_W]]
+ [[/home/ben/Document/Programming/TeX/LaTeX_wikibook.pdf][LaTeX: LaTeX_wikibook]]
+ [[/media/ben/Reserch/Document/Programming/TeX/LatexMathSymbols.pdf][LaTeX: Math Symbols]]
+ [[/usr/local/texlive/2014/texmf-dist/doc/latex/algorithm2e/algorithm2e.pdf][LaTeX: algorithm2e]]
+ [[/usr/local/texlive/2014/texmf-dist/doc/latex/float/float.pdf][LaTeX: float]]
+ [[~/Document/Programming/TeX/doc/minted.pdf][LaTeX: minted]]
+ [[/home/ben/Document/Programming/TeX/LaTeX命令速查手册.pdf][LaTeX命令速查手册]]
+ [[/media/ben/Reserch/Document/Linux/Emacs/ledger3.pdf][LedgerManual]]
+ [[/media/ben/Reserch/Document/Linux/Kernel/Linux内核设计与实现_第三版_清晰中文版.pdf][Linux内核设计与实现_第三版_清]]
+ [[/media/ben/Reserch/Document/Linux/Kernel/Linux内核设计的艺术.pdf][Linux内核设计的艺术.pdf]]
+ [[/home/ben/Wally/GraduationProject/Literature/][Literature]]
+ [[/media/ben/Reserch/Document/Linux/Make/GNUMake项目管理_3rd_Zh.pdf][Make-GNUMake项目管理]]
+ [[/home/ben/Document/Linux/Make/GNUMake项目管理_3rd_Zh.pdf][Make: GNU Make 项目管理]]
+ [[/media/ben/Reserch/Document/EmbeddedSystem/软件手册/OpenocdManual.pdf][Manual: OpenOCD]]
+ [[/home/ben/Document/Programming/Octave/Octave_Manual.pdf][Octave_Manual.pdf]]
+ [[/home/ben/Document/Programming/Octave/octave入门教程.pdf][Octave入门]]
+ [[/media/ben/Reserch/Document/Programming/OpenGL/opengl-tutorials.pdf][OpenGL入门]]
+ [[/media/ben/Reserch/Document/Emacs/Org/org.pdf][Org-Mode手册]]
+ [[/media/ben/Reserch/Document/Linux/Emacs/Org/babel_ref.pdf][OrgBabelRef]]
+ [[/media/ben/Reserch/Document/Programming/Python/CorePythonProgramming_En.pdf][Python: Core Python Programm]]
+ [[/media/ben/Reserch/Document/Programming/Python/PythonCookbook_3rd_En.pdf][PythonCookbook_3rd_En.pdf]]
+ [[~/Document/Programming/Python/Manuals/library.pdf][Python Manual: Library]]
+ [[/media/ben/Reserch/Document/Programming/Python/CorePythonProgramming_Python核心编程_Zh_非扫描版.pdf][Python核心编程]]
+ [[/media/ben/Reserch/Document/Robotics/ROS/book/ros_by_example_hydro___volume_1.pdf][ROSbyExampleV1]]
+ [[/media/ben/Reserch/Document/Robotics/ROS/book/ros_by_example_2_hydro.pdf][ROSbyExampleV2]]
+ [[/media/ben/Reserch/Document/Robotics/Book/IntroductionToAutonomousMobileRobits.pdf][Robotics:Introduction to Aut]]
+ [[/media/ben/Reserch/Document/Linux/Shell/Linux命令行大全.pdf][Shell-Linux命令行大全]]
+ [[/media/ben/Reserch/Document/Linux/Shell/快乐的Linux命令行.pdf][Shell-快乐的Linux命令行]]
+ [[/home/ben/Wally/Journal/journal.org][org-capture-last-stored]]
+ [[/home/ben/Wally/Journal/WallyNotes/Emacs.org][org-refile-last-stored]]
+ [[/media/ben/Reserch/Document/Algorithm/数据结构与算法分析C++描述第三版.pdf][数据结构与算法分析C++描述第三]]
+ [[/media/ben/Reserch/Document/Algorithm/算法导论_中文_第二版扫描版.pdf][算法导论_中文_第二版扫描版.p]]
+ [[~/Document/EmbeddedSystem/芯片手册/CPU/S3C2440.pdf][S3C2440 Manual]]
+ [[~/Document/EmbeddedSystem/芯片手册/CPU/ARM920T.pdf][ARM920T Manual]]
