%--------------------------------------------------------------------------
% parseAndFilterScanFileUtm30lx
% original code by Nikhil Naikal
% modified by George Chen
%
% Parses and filters an input Hokuyo UTM-30LX laser scan file; this file
...
function [xyScans, polarScans, timestamps] = ...
    parseAndFilterScanFileUtm30lx(filename, offset, ...
                                  medFiltSize, threshold, ...
                                  minRange, maxRange, ...
                                  zupts)
...
scans = scans(1+offset:end, 9:end);
...
% specifications from Hokuyo UTM-30LX device
startAngle = -540*360/1440;
stopAngle  = 540*360/1440;
